    ...
    return (
        <div>
            <div className="w-full bg-[rgba(75,62,196,1)]">
                <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row justify-center sm:justify-between items-center gap-2 sm:gap-3 h-[55.8px] px-2 sm:px-0">
                    <button className="w-[58.48px] h-[20.39px] rounded-[800px] bg-white font-inter font-bold text-[12px] leading-[20.4px] text-center text-black">
                        Special
                    </button>
                    <p className='font-inter font-normal text-[14px] leading-[23.8px] text-center'>
                        Get 10% <span className="font-bold uppercase">Discount</span> for first order
                    </p>
                    <Link className='font-inter font-normal italic text-[14px] leading-[23.8px] underline'>
                        Register Now
                    </Link>
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center border-b-[1px] w-full h-auto md:h-[111px] p-4 md:p-0 gap-4 md:gap-0">
                ...
                <div className="flex w-full md:w-[228.59px] h-[45px] justify-start md:justify-end mt-2 md:mt-0">
